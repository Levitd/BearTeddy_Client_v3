...
const Page = ({ children, addStyleTitle = "", addStyle = "", border = " rounded border-2 shadow-md", widthScreen = "", title, pageMargin = " my-2 lg:my-5", noTranslate = false, container = " container xl:container lg:container md:container sm:container" }) => {
    return (
